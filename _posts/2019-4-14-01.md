...
First I needed to get some feel for this strange behaving organism, so I started first with some grow tests to see how they behave. They were grown in Petri dishes . By placing them on a starting point  (S) with 1 oat meal flake as limited food source and a big food source (F) further on.
