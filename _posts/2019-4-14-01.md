...
I discovering that there is a lot of very difficult computation possibilities with smile mold. Which is very cool because this is on the crossroad of biology and computation. I decide that I would start with the fundamental building blocks, namely try to build Logical Gates and progress from there.
